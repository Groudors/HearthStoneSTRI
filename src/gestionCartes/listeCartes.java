...
public class listeCartes {
	...
	public void creeInstanceCarte() {
		List<Serviteur> transition1 = List.of(
				new Serviteur("Acolyte squelletique", 2, 1, 1,null),
		        new Serviteur("Moustique monstrueux", 2, 1, 1,null),
		        new Serviteur("Nécrorateur auchenaï", 3, 1, 1,null),
		        new Serviteur("Ramasse-cadavres", 3, 1, 1,null),
		        new Serviteur("Figure de proue", 2, 3, 2,new EffetProvocation()),
		        new Serviteur("Fossoyeuse nécrotique", 3, 2, 2,new EffetDegats(3)),
		        new Serviteur("Hématurge", 3, 2, 2,new EffetSoins(3)),
		        new Serviteur("Maître-chien de l'effroi", 1, 2, 2,new EffetDegats(2)),
		        new Serviteur("Messagère de l'hiver", 2, 3, 2,null),
		        new Serviteur("Nécromancien belliciste", 2, 2, 2,null),
		        new Serviteur("Pirate os-vermoulu", 4, 1, 2,new EffetDegats(1)),
		        new Serviteur("Porte-froid de la mort", 3, 2, 2,null),
		        new Serviteur("Tank zombie titubant", 2, 3, 2,new EffetProvocation()),
		        new Serviteur("Acolute de la mort", 4, 2, 3,null),
		        new Serviteur("Baron Chute-des-Froids", 2, 2, 3,null),
		        new Serviteur("Chevalier Dess Métal", 4, 3, 3, new EffetProvocation()),
		        new Serviteur("Couturière arc-en-ciel", 3, 3, 3,new EffetSoins(2)),
		        new Serviteur("Falric", 4, 2, 3,null),
		        new Serviteur("Fleur putrescente", 5, 0, 3, new EffetProvocation()),
		        new Serviteur("Flèche des âmes", 2, 2, 3,null),
		        new Serviteur("Infestateur", 2, 4, 3, new EffetDegats(3)),
		        new Serviteur("Boutons", 4, 4, 4,null),
		        new Serviteur("Eliza Lametripe", 3, 4, 4, new EffetSoins(5)),
		        new Serviteur("Garde-essaim nérubien", 3, 1, 4,null),
		        new Serviteur("Horreur malveillante", 4, 2, 4,null),
		        new Serviteur("Thassarian", 3, 3, 4, new EffetProvocation()),
		        new Serviteur("Vipère", 3, 5, 4,null),
		        new Serviteur("Porte-mort Saurcroc", 6, 4, 5, new EffetDegats(4)),
		        new Serviteur("Marionnettiste en herbe", 6, 2, 5,null),
		        new Serviteur("Agent de sécurité", 2, 2, 6,null),
		        new Serviteur("Carcasse repoussante", 5, 3, 6, new EffetSoins(8)),
		        new Serviteur("Croque-gnomes", 6, 5, 6,null),
		        new Serviteur("Exarque Maladaar", 5, 5, 6,null),
		        new Serviteur("Nythendra", 7, 7, 7,null),
		        new Serviteur("Les 8 mains de l'Au-delà", 8, 8, 8, new EffetProvocation()),
		        new Serviteur("Géant raccommodé", 8, 8, 9, new EffetDegats(6)),
		        new Serviteur("Ursoc", 14, 6, 9,null),
		        new Serviteur("Eveilleur d'âmes", 7, 8, 10, new EffetProvocation())
		);
